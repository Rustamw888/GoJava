package Lesson_57.part_2.ManyToOne;

import Lesson_57.part_2.ManyToOne.pojo.Address;
import Lesson_57.part_2.ManyToOne.pojo.Employee;
...
public class MappingHBN {
    ...
    public static void main(String[] args) {
        ...
        Charley.setAge(40);
        address1.setEmployee(Charley);
        address2.setEmployee(Charley);
